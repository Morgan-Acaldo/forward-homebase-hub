  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        primary: "bg-primary text-primary-foreground hover:bg-primary-hover shadow-sm font-medium border border-transparent",
        success: "bg-success text-success-foreground hover:opacity-90 shadow-sm font-medium border border-transparent",
        warning: "bg-warning text-warning-foreground hover:opacity-90 shadow-sm border border-transparent",
